// NOTE: This file mirrors apps/web/src/components/pdfx/table/pdfx-table.tsx. Keep them in sync.
...
import { usePdfxTheme, useSafeMemo } from '../../../lib/pdfx-theme-context.js';
import { createTableStyles } from './pdfx-table.styles.js';
import type {
  TableCellProps,
  TableProps,
  TableRowProps,
