        ...
        {treeConfig.resizable ? (
          ...
          >
            ...
            <span
              ...
              className="bg-primary/60 group-data-resizing/gantt-splitter:bg-primary absolute top-1/2 start-1/2 h-6 w-0.75 -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 rounded-full opacity-0 transition-opacity duration-150 group-hover/gantt-splitter:opacity-100 group-focus-visible/gantt-splitter:opacity-100 group-data-resizing/gantt-splitter:opacity-100"
            />
          </div>
        ) : (
...
function GanttNowDot({
  ...
  return (
    <span
      ...
      className="bg-destructive absolute -bottom-0.75 z-10 size-1.5 -translate-x-1/2 rtl:translate-x-1/2 rounded-full"
      style={{ insetInlineStart: `${fraction * 100}%` }}
    />
  )
}
...
function GanttCustomDragLayer() {
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed top-0 start-0 z-100 will-change-transform"
    ...
    >
      ...
      {draft && draftLabel && (
        ...
        >
          <span className="bg-foreground text-background absolute start-full top-1/2 ms-2 inline-flex w-max -translate-y-1/2 items-center rounded-md px-2 py-1 text-xs font-medium whitespace-nowrap">
            ...
            <span
              aria-hidden
              className="bg-foreground absolute start-0 top-1/2 size-1.5 -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 rotate-45 rounded-[1px]"
            />
          </span>
        </div>
      )}
      ...
      {hintVisible && hintStop && (
        <div
          ...
          className="pointer-events-none absolute z-30 -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 rtl:translate-x-1/2"
          style={{
          ...
          {viewConfig.renderScheduleHint ? (
            ...
            <>
              ...
              <span
                ...
                className={cn(
                  "bg-foreground text-background absolute start-1/2 inline-flex w-max -translate-x-1/2 rtl:translate-x-1/2 items-center rounded-md px-2 py-1 text-xs font-medium whitespace-nowrap",
              ...
              >
                ...
                <span
                  aria-hidden
                  className={cn(
                    "bg-foreground absolute start-1/2 size-2.5 -translate-x-1/2 rtl:translate-x-1/2 rotate-45 rounded-[2px]",
