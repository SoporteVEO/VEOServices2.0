...
/**
 * Full-height mobile-first chrome for the portal: a sticky header with large
 * tap targets and a single-column body sized for a phone held one-handed.
 */
export function InstallerPortalShell({
  title,
  subtitle,
  backHref,
  children,
